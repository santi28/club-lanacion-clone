  ...
  return (
    <section className="mx-auto py-8 md:py-12 lg:py-16 px-4 md:px-8 lg:px-12 items-center">
      <header className="flex justify-between items-center mb-6 gap-4">
        ...
        <button className="font-sans border-blue-600 border-2 text-blue-600 px-4 py-2 rounded-full text-nowrap text-sm font-semibold hover:bg-blue-600 hover:text-white transition-colors">
